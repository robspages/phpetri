...
<?php echo $this->Form->create('SurveyQuestion'); ?>
	<fieldset>
		<legend><?php echo __('Edit Survey Question'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SurveyQuestion.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SurveyQuestion.id'))); ?></li>
